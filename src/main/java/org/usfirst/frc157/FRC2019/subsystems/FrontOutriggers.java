...
public class FrontOutriggers extends Subsystem {
    public static double hatchTarget = -4.35;

	// BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTANTS
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTANTS
    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS
    // public CANSparkMaxfrontOutrigger;
    public NEO frontOutrigger;

    public PID yawFrontPID = new PID(0.28, 0, 0.000009, 9999999, 9999999, 9999999, 999999);
    public PID yawFrontLandingPID = new PID(0.3, 0, 0.00002, 9999999, 9999999, 9999999, 999999);
    ...
    public FrontOutriggers() {
       ...
       frontOutrigger = new NEO (5, MotorType.kBrushless);
       frontOutrigger.setIdleMode(IdleMode.kBrake);
