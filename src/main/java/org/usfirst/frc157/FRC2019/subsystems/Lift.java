...
public class Lift extends Subsystem {
    ...
    public PID downPID = new PID(0.3, 0, 0.00001, 999999, 99999, 999999, 9999999);
    ...
    public static final double HATCH1 = 11;
    public static final double HATCH2 = 46.5;
    public static final double HATCH3 = 80;
    ...
    public void moveLift(double movement, moveType type)
    {
        ...
        if (type == moveType.hold)
        {
            ...
            value = holdPID.pidCalculate(holdPosition, encoder.get());
            lift.set(value);
        }
        else
        {
