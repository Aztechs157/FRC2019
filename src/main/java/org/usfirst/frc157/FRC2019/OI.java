...
public class OI {
    ...
    public int GreenLight = 5;// green 3.6
    public int RedLIGHT= 6;//red light
	...
	public OI() {
        ...
        L1 = new JoystickButton(joystick1, 5);
        ...
        if (Robot.key.get())
        {
            ...
            //ALLUP.whenPressed(new HatchController()); 
            L1.whenPressed(new AutoHatchIntake());
            R1.whenPressed(new processVision());
            HATCHINTAKE = new JoystickButton(joystick2, 14); 
            HATCHOUTAKE = new JoystickButton(joystick2, 15); 
            ...
            HATCHINTAKE.whenPressed(new HatchSet(true)); 
            HATCHOUTAKE.whenPressed(new HatchSet(false)); 
           
            ALLDOWN.whileHeld(new SetPID()); 
