...
public class GetOffHab2 extends Command {
    ...
    {
        double frontPos = Robot.outriggers.frontOutrigger.getPosition();
        double backPos = Robot.outriggers.backOutrigger.getPosition();
        ...
        switch (state) {
            case lower:
                ...
                break;
            case drive:
                state = (forward.execute())? states.raise: states.drive;
                break;
            case raise:
                frontTarget = 0;
                backTarget = 0;
      ...
      //  System.out.println("\n------\n" + value + "\n" + target);
        double moveFront = Robot.outriggers.yawFrontPID.pidCalculate(frontTarget, frontPos);
        double moveBack = Robot.outriggers.yawBackPID.pidCalculate(backTarget, backPos);
