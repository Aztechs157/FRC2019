...
public class Robot extends TimedRobot {
    ...
    public OutriggersController outriggerController;
    ...
    public void robotInit() {
        ...
        vision = new Vision();
        outriggerController = new OutriggersController(1, 1);
    ...
    public void teleopInit() {
        ...
        frontOutriggers.frontOutrigger.tare();
        backOutriggers.backOutrigger.tare();

        if (autonomousCommand != null) autonomousCommand.cancel();
        outriggerController.start();
    }
